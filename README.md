...
Most browsers declare default styling on most elements. When styling a web page, you have to override browsers’ stylesheets to get what you want.
...
## Get started
To use this reset, download `reset.css` and include it in your HTML page, before any other CSS. Feel free to customize things.
